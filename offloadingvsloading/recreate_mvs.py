#!/usr/bin/env python3
"""Recreate offloading_vs_loading materialized views with corrected formulas."""
import psycopg2
...
def recreate_mvs():
    """Recreate all offloading_vs_loading materialized views."""
    try:
        ...
        conn.commit()
        conn.close()
        print("✅ All MVs recreated successfully with corrected formulas!")
    except psycopg2.Error as e:
        print(f"❌ Error: {e}")

if __name__ == '__main__':
    print("🔄 Recreating offloading MVs...")
    recreate_mvs()
