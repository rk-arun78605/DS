...
<style>
    ...
    .metric-card {{
        ...
        border-left: 2px solid {{MELCOM_BLUE}};
        height: auto;
        min-height: 60px;
        min-width: 100px;
        display: flex;
...
def main():
    ...
    <div class="dashboard-header">
        <div class="dashboard-title">
            <img src="https://melcom.com/media/favicon/stores/1/faviconn_162_x_184px.jpg" alt="Melcom" style="height:36px; vertical-align:middle; margin-right:10px;">MELCOM STAR (Serial Tracking & Reporting)
        </div>
        <div class="dashboard-subtitle">Serial movement tracking and compliance monitoring</div>
    </div>
    """, unsafe_allow_html=True)
    ...
    with tab1:
        ...
        if wh_metrics and shop_metrics:
            ...
            with col1:
                ...
                st.markdown(f"""
                <div class="metric-card {wh_received_class}" title="Total records in whreceived_serialno with non-blank serial_no">
            ...
            with col2:
                ...
                st.markdown(f"""
                <div class="metric-card {wh_loaded_class}" title="Total records in serial_no_dailydata with non-blank serial_no">
        ...
        if not overview_7day_metrics:
            ...
            with overview_compliance_cols[2]:
                ...
                if by_shop_7day is not None and not by_shop_7day.empty:
                    ...
                    if not selected_shop_overview_compliance:
                        ...
                        display_df_7day = display_df_7day.rename(columns={
                            ...
                            'total_yes': 'Total Yes',
                            'yes_pct': 'last 7 Day Compliance%'
                        })
                        
                        if 'Shop Code' in display_df_7day.columns:
                            display_df_7day['Shop Code'] = display_df_7day['Shop Code'].astype(str).str.strip()
                        
                        pct_min_7day = display_df_7day['last 7 Day Compliance%'].min()
                        pct_max_7day = display_df_7day['last 7 Day Compliance%'].max()
                        
                        def _compliance_gradient_7day_summary(col: pd.Series):
                            styles = []
                            if col.name == 'last 7 Day Compliance%':
                        ...
                        styled_7day = (
                            display_df_7day
                            .style
                            .format({'Total Serials': '{:d}', 'Total Yes': '{:d}', 'last 7 Day Compliance%': '{:.1f}%'})
                            .apply(_compliance_gradient_7day_summary)
                        )
                        
                        st.markdown("### Click on any shop row to view 7-day drill-down with cashier breakdown")
                        ...
                        event_7day = st.dataframe(
                            ...
                            column_config={
                                ...
                                "last 7 Day Compliance%": st.column_config.NumberColumn("last 7 Day Compliance%", format="%.1f%%")
                            }
                        )
    ...
    with tab2:
        ...
        if wh_metrics:
            ...
            with col2:
                ...
                st.markdown(f"""
                <div class="metric-card {wh_rec_unique_class}" title="Distinct serial_no in whreceived_serialno">
