...
<div style="display:flex;flex-direction:column;align-items:center;justify-content:center;
  ...
  <div style="position:relative;width:36px;height:2px;
    ...
    # ══════════════════════════════════════════════════════════
    st.markdown('<div style="height:8px;"></div>', unsafe_allow_html=True)
    st.markdown("### 📦 Department Compliance Analysis")
    st.caption(f"📅 Summary: {start_s} → {end_s} | Trend: Last 7 Days (up to yesterday)")
    render_dept_compliance_section(start_s, end_s)
